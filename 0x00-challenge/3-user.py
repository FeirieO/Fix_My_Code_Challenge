...
class User():
    ...
    def __init__(self):
        ...
        self.__password = None  # Fixed the variable name here
    ...
    def is_valid_password(self, pwd):
        ...
        if self.__password is None:
            return False
        return hashlib.md5(pwd.encode()).hexdigest().lower() == self.__password  # Fixed the comparison and converted to lowercase
